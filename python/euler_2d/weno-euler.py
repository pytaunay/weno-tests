...
axarr[0,0].plot(zvec,U[:,0],'-')
axarr[0,1].plot(zvec,P,'-')
axarr[1,0].plot(zvec,P/U[:,0],'-')
axarr[1,1].plot(zvec,U[:,1]/U[:,0],'-')
axarr[2,0].plot(zvec,U[:,1]/U[:,0]/asos,'-')
axarr[2,1].plot(zvec,U[:,2]/U[:,0],'-')
