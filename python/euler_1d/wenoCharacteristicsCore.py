...
def compute_weights(up1,u,um1,order,up2=0,um2=0):
    if order == 3:
        d0 = 2/3
        d1 = 1/3
...
# For the characteristics core, U is an Nelem x (order x NUNK) matrix
def compute_lr(U,order):
    ...
    if order == 3:
        ...
        w0,w1,w2,wt0,wt1,wt2 = compute_weights(up1,u,um1,order,up2,um2)
